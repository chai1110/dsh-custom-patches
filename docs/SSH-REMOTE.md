...
## 🔗 [chai1110/dsh-ssh-remote](https://github.com/chai1110/dsh-ssh-remote)
...
- **版权归属**：底层引擎来自上游 `dsh-remote`（`Copyright (c) 2026 dsh-remote contributors`，MIT）；多池并行与 rc.8 适配为本仓库增量修改（chai1110）
- **第三方声明**：完整组件与许可证列表见独立仓库的 [THIRD_PARTY_NOTICES.md](https://github.com/chai1110/dsh-ssh-remote/blob/main/THIRD_PARTY_NOTICES.md)
